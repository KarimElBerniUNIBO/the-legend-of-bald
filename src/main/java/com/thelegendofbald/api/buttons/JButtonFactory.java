...
public interface JButtonFactory {
     ...
     */
    RectangleButton createRectangleButton(String text, Dimension parentSize,
            Optional<Pair<Double, Double>> moltiplicator, Optional<Color> bgColor, Optional<String> fontName,
     ...
     * @param parentSize    the Dimension representing the size of the parent
     *                      component
     ...
     *         parameters
     */
    RectangleButton createRectangleButton(ImageIcon icon, Dimension parentSize,
            Optional<Pair<Double, Double>> moltiplicator, Optional<Color> bgColor, Optional<Color> fgColor);
     ...
     */
    RoundedButton createRoundedButton(String text, Dimension parentSize, Optional<Pair<Double, Double>> moltiplicator,
            double arcProportion, Optional<Color> bgColor, Optional<String> fontName, Optional<Color> fontColor,
     ...
     * @param parentSize    the {@link Dimension} representing the parent
     *                      component's size, used to determine button size
     ...
     *         parameters
     */
    RoundedButton createRoundedButton(ImageIcon icon, Dimension parentSize,
     ...
     *
     * @param text          the text to display on the button
     * @param parentSize    the size of the parent component, used for sizing the
     *                      button
     ...
     */
    TrasparentBackgroundButton createTrasparentButton(String text, Dimension parentSize,
            Optional<Pair<Double, Double>> moltiplicator, Optional<String> fontName, Optional<Color> fontColor,
            Optional<Integer> fontType);
     ...
     *         the provided parameters
     */
    TrasparentBackgroundButton createTrasparentButton(ImageIcon icon, Dimension parentSize,
     ...
     */
    KeybindingButton createKeybindingButton(String text, Dimension parentSize,
            Optional<Pair<Double, Double>> moltiplicator, double arcProportion, Optional<Color> bgColor,
     ...
     *         parameters
     */
    KeybindingButton createKeybindingButton(ImageIcon icon, Dimension parentSize,
            Optional<Pair<Double, Double>> moltiplicator, double arcProportion, Optional<Color> bgColor,
            Optional<Color> fgColor);
