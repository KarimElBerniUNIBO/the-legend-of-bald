 ...
 * <p>
 * This factory is responsible for creating instances of {@link TextLabel} with customizable
...
public final class TextLabelFactoryImpl implements TextLabelFactory {
    ...
    public TextLabel createTextLabelWithProportion(final String text, final Dimension size,
        ...
        return new TextLabel(text, size, moltiplicator.orElse(DEFAULT_MOLTIPLICATOR),
