...
public class BackToMainPanel extends JPanel {
    ...
    private static final double IMAGE_PROPORTION = 0.01;
    ...
    public BackToMainPanel(Dimension size) {
        ...
        backButton = jbFactory.createTrasparentButton("Back", new Dimension(PANEL_WIDTH, PANEL_HEIGHT), Optional.empty(), Optional.of(Color.WHITE), Optional.empty());
