...
public abstract class TemplateButtonMouseListener extends MouseAdapter {
    ...
    protected final SoundPlayer mouseHover = new SoundPlayer(MOUSE_HOVER_SFX_PATH);
    protected final SoundPlayer mousePressed = new SoundPlayer(MOUSE_PRESSED_SFX_PATH);
    protected final SoundPlayer mouseReleased = new SoundPlayer(MOUSE_RELEASED_SFX_PATH);
